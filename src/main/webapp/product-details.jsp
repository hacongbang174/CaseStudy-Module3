            ...
            <div class="col-lg-5 col-md-5">
                <div class="product-details-tab">
                    ...
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="${ProductData.getImg()}" data-zoom-image="${ProductData.getImg()}"
                                 alt="product">
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a class="primary_img"
                                       href="product?action=productDetail&product_id=${pc.getProduct_id()}"><img
                                            src="${pc.getImg()}" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <h3>
                                        <a href="product?action=productDetail&product_id=${pc.getProduct_id()}">${pc.getProduct_name()}</a>
                                    </h3>
