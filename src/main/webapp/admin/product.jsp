                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.ProductData}" var="p">
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary btn-sm trash" type="button" title="Xóa" value="${p.getProduct_id()}"><i
                                                            class="fas fa-trash-alt"></i>
                                                    </button>
                                                    <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
                                                            data-toggle="modal" data-target="#ModalUP${p.getProduct_id()}"><i class="fas fa-edit"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="modal fade" id="ModalUP${p.getProduct_id()}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                                             data-keyboard="false">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control" type="text" readonly name="product_id" value="${p.getProduct_id()}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control" type="text" name="product_name" required value="${p.getProduct_name()}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Giá</label>
                                                                <input class="form-control" type="number" name="product_price" required value="${p.getProduct_price()}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Màu</label>
                                                                <input class="form-control" name="product_color" type="text" value="<c:forEach items="${requestScope.ColorData}" var="c"><c:if test="${p.getProduct_id()==c.getProduct_id()}">${c.getColor()},</c:if></c:forEach>">
                                                                    </div>

                                                                    <div class="form-group col-md-6">
                                                                        <label class="control-label">Size</label>
                                                                        <input class="form-control" name="product_size" type="text" value="<c:forEach items="${requestScope.SizeData}" var="s"><c:if test="${p.getProduct_id()==s.getProduct_id()}">${s.getSize()},</c:if></c:forEach>">
                                                                    </div>

                                                                    <div class="form-group col-md-6">
                                                                        <label class="control-label">Thông tin</label>
                                                                        <input class="form-control" type="text" name="product_describe" value="${p.getProduct_describe()}">
                                                            </div>

                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Số lượng</label>
                                                                <input class="form-control" type="text" name="product_quantity" value="${p.getQuantity()}">
                                                            </div>
                                                            <!--anh san pham-->
                                                            <div class="form-group col-md-12">
                                                                <label class="control-label">Ảnh sản phẩm</label>
                                                                <div id="myfileupload">
                                                                    <input type="file" id="uploadfile" name="product_img" value="${p.getImg()}" onchange="readURL(this);" />
                                                                </div>
                                                                <div id="thumbbox">
