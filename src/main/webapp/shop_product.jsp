            ...
            <div class="row">
                        ...
                        <div class="widget_list widget_categories">
                            ...
                            <ul>
                                ...
                                <c:forEach items="${requestScope.CategoryData}" var="c">
                                    <li>
                                        <a href="product?action=listByCategory&category_id=${c.getCategoryID()}">${c.getCategoryName()}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="shop_toolbar_wrapper" style="border:none">
                        <div class="dropdown ">
                            <button style="color: #000; background-color: #ffffff;border:none; font-family: sans-serif;"
                                    class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Bộ lọc
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="product?action=sortProductByPriceAsc&type=low">Giá từ
                                    thấp đến cao</a>
                                <a class="dropdown-item" href="product?action=sortProductByPriceDesc&type=high">Giá từ
                                    cao xuống thấp</a>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    ...
                                    <div class="product_content grid_content">
                                        <h3>
                                            <a href="product?action=productDetail&product_id=${p.getProduct_id()}">${p.getProduct_name()}</a>
                                        </h3>
