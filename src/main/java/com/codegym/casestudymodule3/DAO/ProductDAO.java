...
public class ProductDAO {
    ...
    public List<Product> getProduct() {
        ...
        String sql = "select c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id;";
        try {
    ...
    public void insertProduct(Product product) {
        ...
        try {
            ...
            ps.setInt(2, product.getCate().getCategoryID());
    ...
    public void updateProduct(Product product) {
        ...
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            ps.setInt(1, product.getCate().getCategoryID());
    ...
    public List<Product> getTop10Product() {
        List<Product> list = new ArrayList<>();
        String sql = "SELECT p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img FROM product p ORDER BY p.product_id DESC LIMIT 10;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public List<Product> getProductByPriceAsc() {
        List<Product> list = new ArrayList<>();
        String sql = "select c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id ORDER BY p.product_price ASC;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public List<Product> getProductByPriceDesc() {
        List<Product> list = new ArrayList<>();
        String sql = "select c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id ORDER BY p.product_price DESC;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public List<Product> getProductByName() {
        List<Product> list = new ArrayList<>();
        String sql = "select c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id ORDER BY p.product_name;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            rs = ps.executeQuery();
    ...
    public List<Product> getProductByCategory(int category_id) {
        List<Product> list = new ArrayList<>();
        String sql = "select c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id WHERE p.category_id=?;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
    ...
    public Product getProductByID(String product_id) {
        List<Product> list = new ArrayList<>();
        String sql = "select c.category_id, c.category_name , p.product_id , p.product_name, p.product_price, p.product_describe, p.quantity,p.img from product p join category c on p.category_id = c.category_id WHERE p.product_id=?;";
        try {
            conn = new DBContext().getConnection();
            ps = conn.prepareStatement(sql);
            ps.setString(1, product_id);
